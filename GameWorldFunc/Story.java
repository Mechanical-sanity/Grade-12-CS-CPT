...
public class Story {
    ...
    */
    ...
    public void spawnLocation(){
        ...
        //sets up room layout
        adjacentRooms = world.getadjacentroomList(0);
  ...
  public void celebrate(){
    ...
    gameText.mainTextArea.setText("Great job. The Demon lord has been sealed away from another million years. Thank you hero for saving this world, come back whenever you want to claim your glory once again");
